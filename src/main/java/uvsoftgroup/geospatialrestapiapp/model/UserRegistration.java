 ...
 * 
 */
package uvsoftgroup.geospatialrestapiapp.model;
...
public class UserRegistration implements Serializable {
	...
	@Id
	@GenericGenerator(name = "seq_useregistration", strategy = "uvsoftgroup.geospatialrestapiapp.utility.UserRegistrationIdGenerator")
	...
	private List<GeometryGisInfo> geometryGisInfos = new ArrayList<GeometryGisInfo>();
